// Code generated by the Encore v1.56.4 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-quiz-backend-wbii.encr.app`
}
...
/**
 * Client is an API client for the quiz-backend-wbii Encore application.
 */
export default class Client {
    public readonly admin: admin.ServiceClient
    public readonly auth: auth.ServiceClient
    public readonly quiz: quiz.ServiceClient
    ...
    constructor(target: string | BaseURL = "prod", options?: string | ClientOptions) {
        ...
        this.quiz = new quiz.ServiceClient(base)
...
export namespace admin {
    ...
    export class ServiceClient {
        ...
        public async CreateQuiz(params: CreateQuizParams): Promise<QuizResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/admin/quizzes`, JSON.stringify(params))
            return await resp.json() as QuizResponse
        }

        public async DeleteQuiz(id: number): Promise<void> {
            await this.baseClient.callTypedAPI("DELETE", `/admin/quizzes/${encodeURIComponent(id)}`)
        }

        public async GetQuiz(id: number): Promise<Quiz> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/admin/quizzes/${encodeURIComponent(id)}`)
            return await resp.json() as Quiz
        }

        public async ListQuizzes(): Promise<QuizList> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/admin/quizzes`)
            return await resp.json() as QuizList
        }

        public async TogglePublish(id: number): Promise<PublishResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/admin/quizzes/${encodeURIComponent(id)}/publish`)
            return await resp.json() as PublishResponse
        }

        public async UpdateQuiz(id: number, params: CreateQuizParams): Promise<QuizResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PUT", `/admin/quizzes/${encodeURIComponent(id)}`, JSON.stringify(params))
            return await resp.json() as QuizResponse
        }
    }
}
...
export namespace auth {
    ...
    export class ServiceClient {
        ...
        public async Register(params: RegisterParams): Promise<TokenResponse> {
            // Now make the actual call to the API
...
export namespace quiz {
    ...
    export class ServiceClient {
        ...
        public async GetQuiz(id: number): Promise<QuizDetail> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/quizzes/${encodeURIComponent(id)}`)
            return await resp.json() as QuizDetail
        }

        public async ListQuizzes(): Promise<QuizList> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/quizzes`)
            return await resp.json() as QuizList
        }

        public async SubmitQuiz(id: number, params: SubmitParams): Promise<SubmitResult> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/quizzes/${encodeURIComponent(id)}/submit`, JSON.stringify(params))
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "quiz-backend-wbii-Generated-TS-Client (Encore/v1.56.4)";
        }
